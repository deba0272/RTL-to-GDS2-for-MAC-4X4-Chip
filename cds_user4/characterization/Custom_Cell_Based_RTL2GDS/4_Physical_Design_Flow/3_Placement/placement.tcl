...
#setPlaceMode -place_design_floorplan_mode false -place_design_refine_place true -place_global_cong_effort high -place_global_max_density 0.75 -place_global_place_io_pins false -place_global_clock_gate_aware false -place_global_reorder_scan false


### for without scan chain global_io_pins change to true
setPlaceMode -place_design_floorplan_mode false -place_design_refine_place true -place_global_cong_effort high -place_global_max_density 0.70 -place_global_place_io_pins true -place_global_clock_gate_aware false -place_global_reorder_scan false
