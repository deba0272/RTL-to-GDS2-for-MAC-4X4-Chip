...
globalNetConnect VSS_CORE -type pgpin -pin GND -all
...
addRing -nets {VDD_CORE VSS_CORE} -type core_rings -follow core -center 1 -layer {top M5 bottom M5 left TOP_M right TOP_M} -width {top 11.2 bottom 11.2 left 11.2 right 11.2} -spacing {top 11.2 bottom 11.2 left 11.2 right 11.2} -offset {top 11.2 bottom 11.2 left 11.2 right 11.2} -snap_wire_center_to_grid None
