...
# Generated on: Mon Jun 22 15:32:27 IST 2026 (Mon Jun 22 10:02:27 UTC 2026)
...
set logfile fv/mac_4x4_wrapper_chip/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mac_4x4_wrapper_chip -revised fv_map
...
read_library -liberty -both \
    /tools/sclpdk_new/SCLPDK_V3.0_KIT/scl180/stdcell/fs120/6M1L/liberty/lib_flow_ss/tsl18fs120_scl_ss.lib \
    /tools/sclpdk_new/SCLPDK_V3.0_KIT/scl180/iopad/cio150/6M1L/liberty/tsl18cio150_max.lib \
    /tools/sclpdk_new/SCLPDK_V3.0_KIT/scl180/stdcell/fs120/6M1L/liberty/lib_flow_ff/tsl18fs120_scl_ff.lib \
    /tools/sclpdk_new/SCLPDK_V3.0_KIT/scl180/iopad/cio150/6M1L/liberty/tsl18cio150_min.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl_7/top_wrapper.v ../rtl_7/mac.v
elaborate_design -golden -root {mac_4x4_wrapper_chip} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mac_4x4_wrapper_chip/fv_map.v.gz
elaborate_design -revised -root {mac_4x4_wrapper_chip}
...
#add_name_alias fv/mac_4x4_wrapper_chip/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.mac_4x4_wrapper_chip.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mac_4x4_wrapper_chip.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mac_4x4_wrapper_chip.rtl.fv_map.rpt
